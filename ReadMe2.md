# $${\color{blue}Training \space und \space Evaluation \space eines \space ML-Agenten \space in \space Unity}$$
...
## $${\color{green}1. \space Titel \space und \space Kurzbeschreibung \space (Kapitel \space 1)}$$
...
## $${\color{green}2. \space Technische \space Anforderungen \space (Kapitel \space 4.1)}$$
...
## $${\color{green}3. \space Architektur \space des \space Agenten \space (Kapitel \space 4.5, \space 4.7, \space 4.8)}$$

### $${\color{orange}3.1 \space Zentrale \space Agentenkomponenten}$$
...
### $${\color{orange}3.2 \space Sensorik \space und \space Beobachtungen}$$
...
### $${\color{orange}3.3 \space Aktionsverarbeitung}$$
...
### $${\color{orange}3.4 \space Belohnungslogik \space (Rewards) \space und \space Verhaltenssteuerung}$$
...
## $${\color{green}4. \space Trainingsumgebung \space und \space Level-Design \space (Kapitel \space 4.4)}$$

### $${\color{orange}4.1 \space Überblick \space und \space progressive \space Komplexität}$$
...
### $${\color{orange}4.2 \space Hindernistypen \space und \space Umgebungselemente}$$
...
### $${\color{orange}4.3 \space Struktur \space und \space Beispiele \space der \space Level \space (Auszug)}$$
...
### $${\color{orange}4.4 \space Levelanzahl \space und \space Varianten \space im \space finalen \space Trainingssetup}$$
...
## $${\color{green}5. \space Trainingsstrategien \space und \space Hyperparameter \space (Kapitel \space 4.10, \space 4.11.3, \space 4.12)}$$

### $${\color{orange}5.1 \space Lernalgorithmus \space und \space Netzwerkarchitektur}$$
...
### $${\color{orange}5.2 \space Zentrale \space Hyperparameter \space (Auszug)}$$
...
### $${\color{orange}5.3 \space Trainingsstrategien \space 1–6 \space (Kapitel \space 4.12)}$$
...
### $${\color{orange}5.4 \space Eigene \space Automatisierungslösung \space (Kapitel \space 4.11.3)}$$
...
### $${\color{orange}5.5 \space Trainingsablauf \space und \space TensorBoard \space (Kapitel \space 4.11.2, \space 4.11.4)}$$
...
## $${\color{green}6. \space Ergebnisse \space und \space Evaluation \space (Kapitel \space 5.4, \space 5.5)}$$

### $${\color{orange}6.1 \space Leistungsanalyse \space des \space finalen \space Modells \space (Strategie \space 6)}$$
...
### $${\color{orange}6.2 \space Generalisierungsfähigkeit}$$
...
## $${\color{green}7. \space Fazit \space und \space Ausblick \space (Kapitel \space 6)}$$

### $${\color{orange}7.1 \space Zusammenfassung \space der \space Ergebnisse}$$
...
### $${\color{orange}7.2 \space Bewertung \space des \space Lösungsansatzes \space und \space Limitationen}$$
...
### $${\color{orange}7.3 \space Ausblick \space (zukünftige \space Erweiterungen)}$$
